package com.identity.map
{
	...
	{			
		...
		override public function dispose():void
		{
			...
			if(this.colorSprite&&this.contains(colorSprite))
			{
				this.removeChild(colorSprite);
			}
		...
		override public function draw():void
		{
			...
			if(this.colorSprite)
			{
				colorSprite.x=(this.width-this.colorSprite.width)/2;
			}
        ...
        override public function mapClearLayer(e:MapEvent):void
		{
			if(colorSprite)
			{
				colorSprite.dispose();
