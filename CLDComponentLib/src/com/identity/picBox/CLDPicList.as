...
//			
		...
		private function imgClick(e:ImgEvent):void
		{
			...
			e.stopPropagation();	
			var pic:ClDPicBorder=e.currentTarget as ClDPicBorder;
			if(pic)
			{
				var mes:Message=Message.buildMsg(CMD.PHOTO_SINGLE_CLICK);
				mes.data={imgIndex:pic.index};
