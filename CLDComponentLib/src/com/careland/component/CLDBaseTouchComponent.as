package com.careland.component
{
	...
	public class CLDBaseTouchComponent extends CLDBaseComponent
	{
		...
		public function CLDBaseTouchComponent(parent:DisplayObjectContainer=null, xpos:Number=0, ypos:Number=0)
		{
		...
		*/
		...
		public function set canScale(value:Boolean):void
		{
			if(!this._canScale!=value){
