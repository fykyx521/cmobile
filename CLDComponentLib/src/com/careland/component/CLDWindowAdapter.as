...
//			closeButton.visible=true;
			if(!this.hasEventListener("rightClick"))
			{
...
//				this.produceName="P_根据ID获取弹出窗口信息";
		...
		override public function draw():void
		{
			...
			if(this.isBack&&this.border&&this.rect)
			{
		...
		override protected function updateContent(w:Number,h:Number):void
		{
			 if(isBack&&this.content)
			 {
				  this.content.x=this.content.y=0;
				  this.content.setSize(this.width,this.height);
			 }else
			 {
				 super.updateContent(w,h);
			 }
		}
