package uk.co.teethgrinder.elements.menu {
	...
	import uk.co.teethgrinder.elements.menu.menuItem;
	...
	public class Menu extends Sprite {
		...
		private function draw(width:Number, height:Number): void {
			...
			var colour:Number = uk.co.teethgrinder.string.StringUtils.get_colour( this.props.get('colour') );
			var o_colour:Number = uk.co.teethgrinder.string.StringUtils.get_colour( this.props.get('outline-colour') );
