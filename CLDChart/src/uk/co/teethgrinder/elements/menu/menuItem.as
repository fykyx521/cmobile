package uk.co.teethgrinder.elements.menu {
	...
	public class menuItem extends Sprite {
		...
		private function draw_bg( width:Number ):void {
			this.graphics.beginFill(uk.co.teethgrinder.string.StringUtils.get_colour( this.props.get('background-colour') ));
		...
		protected function add_text(text:String, left:Number): Number {
			...
			fmt.color = uk.co.teethgrinder.string.StringUtils.get_colour( this.props.get('text-colour') );
			fmt.font = 'Verdana';
...
//			title.border = true;
		...
		public function mouseOverHandler(event:MouseEvent):void {
			...
			glow.color = uk.co.teethgrinder.string.StringUtils.get_colour( this.props.get('glow-colour') );
			glow.alpha = 0.8;
			glow.blurX = 4;
			glow.blurY = 4;
			glow.inner = false;
