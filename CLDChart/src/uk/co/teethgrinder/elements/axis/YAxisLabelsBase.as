package uk.co.teethgrinder.elements.axis {
	...
	import uk.co.teethgrinder.elements.axis.YTextField;
...
import uk.co.teethgrinder.tr;
		...
		private function make_label( lblStyle:Object ):YTextField
		{
			...
			lblStyle.colour = uk.co.teethgrinder.string.StringUtils.get_colour(lblStyle.colour);
			...
			fmt.font = lblStyle.rotate == "vertical" ? "msyh" : "msyh";
