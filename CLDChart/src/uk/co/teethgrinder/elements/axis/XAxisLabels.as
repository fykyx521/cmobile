package uk.co.teethgrinder.elements.axis {
	...
	import uk.co.teethgrinder.elements.axis.AxisLabel;
	import uk.co.teethgrinder.string.StringUtils;
	import uk.co.teethgrinder.string.DateUtils;
		...
		public function add( label:Object, style:Object ) : void
		{
			...
			if (label_style.visible) {
				...
				if( label_style.colour is String )
					label_style.colour = StringUtils.get_colour( label_style.colour );
