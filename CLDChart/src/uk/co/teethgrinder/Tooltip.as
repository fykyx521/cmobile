package uk.co.teethgrinder {
	...
	import uk.co.teethgrinder.string.Css;
	...
	public class Tooltip extends Sprite {
		...
		public function Tooltip( json:Object )
		{
			...
			this.style.colour = StringUtils.get_colour( this.style.colour );
			this.style.background = StringUtils.get_colour( this.style.background );
		...
		private function get_pos( e:has_tooltip ):flash.geom.Point {
			...
			var x1:Number = (pos.x + this.width + 16) > this.stage.stageWidth ? (this.stage.stageWidth - this.width - 16) : pos.x;
			
			var y1:Number = pos.y;
			y1 -= 4;
			y1 -= (this.height + 10 ); // 10 == border size
			...
			if( "global" in pos ){
				return this.parent.globalToLocal(new Point(x1,y1));
			} else {
