package uk.co.teethgrinder.charts {
	...
	import uk.co.teethgrinder.charts.series.dots.HollowDotElement;
	import uk.co.teethgrinder.charts.series.dots.dot_factory;
	...
	public class LineHollow extends LineBase
	{
		...
		public function LineHollow( json:Object )
		{
			...
			this.style.colour = uk.co.teethgrinder.string.StringUtils.get_colour( this.style.colour );
