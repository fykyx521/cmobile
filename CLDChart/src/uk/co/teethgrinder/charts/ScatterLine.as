package uk.co.teethgrinder.charts {
	...
	import uk.co.teethgrinder.charts.series.dots.DefaultDotProperties;
	...
	public class ScatterLine extends ScatterBase
	{
		...
		public function ScatterLine( json:Object )
		{
			...
			this.style.colour = uk.co.teethgrinder.string.StringUtils.get_colour( style.colour );
		...
		public function solid_line( sc:ScreenCoordsBase ): void {
			...
			if (areaStyle != null)
			{
				...
				{
					areaColour = uk.co.teethgrinder.string.StringUtils.get_colour( areaStyle.colour );
				}
			...
			for ( var i:Number = 0; i < this.numChildren; i++ ) {
				...
				if( tmp is Element )
				{
					...
					e.resize( sc,this.width,this.height );
					if (!e.visible)
					{
