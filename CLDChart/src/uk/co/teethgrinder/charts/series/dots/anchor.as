package uk.co.teethgrinder.charts.series.dots {
	...
	public class anchor extends PointDotBase {
		...
		public function anchor( index:Number, value:Properties ) {
			...
			var colour:Number = uk.co.teethgrinder.string.StringUtils.get_colour( value.get('colour') );
...
//			{
				...
				if (value.get('hollow'))
				{
					...
					{
						var bgColor:Number = uk.co.teethgrinder.string.StringUtils.get_colour( value.get('background-colour') );
					}
					else
					{
						bgColor = colour;
