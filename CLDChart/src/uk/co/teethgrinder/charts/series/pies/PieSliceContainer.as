package uk.co.teethgrinder.charts.series.pies {
	...
	public class PieSliceContainer extends Element {
		...
		public function PieSliceContainer( index:Number, value:Properties )
		{
			...
			var l:String = value.get('no-labels') ? '' : this.pieSlice.label;
		...
		public override function get_tip_pos():Object {
			...
			//var u:flash.geom.Point = this.stage.globalToLocal(p);
			//return {x:u.x,y:u.y};
