package com.careland.layer
{
	...
	public class CLDCircle extends CLDBaseMarker
	{
		...
		public function change(center:Point,gl:Point,mapconfig:MapConfig):void
		{
			this.screenPoint=this.getScreenPoint(this.cldPoint,gl,mapconfig);
			var screenP1:Point=this.getScreenPoint(this._radiusp,gl,mapconfig);
