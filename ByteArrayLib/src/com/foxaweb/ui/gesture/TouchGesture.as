...
package com.foxaweb.ui.gesture {
	...
	public class TouchGesture extends EventDispatcher {
		...
		function TouchGesture(pZone:InteractiveObject){
		...
		*/
		protected function init():void{
			...
			// Mouse Events
			mouseZone.addEventListener(TUIOEvent.TUIO_DOWN,startCapture,false,0,true);
			mouseZone.addEventListener(TUIOEvent.TUIO_UP,stopCapture,false,0,true);
		...
		*/
		protected function captureHandler(e:TimerEvent):void{
			...
			var tuio:TUIOObject=TUIO.getObjectById(blob1.id);
			if(tuio){
				var lp:Point=this.mouseZone.parent.globalToLocal(new Point(tuio.x,tuio.y));
				msx=lp.x;
				msy=lp.y;
			}
		...
		*/
		protected function startCapture(e:TUIOEvent):void{
			...
			var tuio:TUIOObject=TUIO.getObjectById(e.ID);
			if(tuio){
				var lp:Point=this.mouseZone.parent.globalToLocal(new Point(tuio.x,tuio.y));
				lastPoint=new Point(lp.x,lp.y);
			}
		...
		*/
		protected function stopCapture(e:TUIOEvent):void{
